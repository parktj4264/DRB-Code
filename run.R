...
OUTPUT_FILENAME <- "results.csv"  # Result file (saved in 'output/' folder)

# Analysis Settings
HOT_BIN_LIMIT   <- 130             # Filter cutoff
SIGMA_THRESHOLD <- 0.5             # Threshold for Up/Down direction
N_CORES         <- NULL            # Set to Integer (e.g., 4) to force specific cores. NULL = Auto.
